...
### Step 4.5: Plan Mode 가이드 표시 (복잡도 >= 5인 경우)

**조건**: `{complexityScore} >= 5` (Major 작업)

복잡한 작업인 경우 Plan Mode 사용을 안내합니다:
...
Plan Mode를 사용하여 상세 계획을 수립한 후 구현을 시작하시는 것을 권장합니다.

## 🎯 Option A: Plan Mode 사용 (권장)

Plan Mode에서 체계적인 계획을 수립한 후 구현을 시작할 수 있습니다:

**1단계:** `Shift+Tab` 누르기 → Plan Mode 진입

**2단계:** 다음과 같이 요청하기:
```
"{사용자 요청}"의 상세 구현 계획을 작성해주세요.
...
## ⚡ Option B: 바로 Major 워크플로우 시작

Plan Mode를 건너뛰고 질문-응답 방식으로 바로 진행합니다.

---
```

**중요**: Plan Mode 가이드는 선택사항입니다. 사용자가 바로 Major 워크플로우를 시작할 수도 있습니다.
