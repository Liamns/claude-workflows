...
install_workflows() {
    ...
    echo ""
    echo "2. 워크플로우 선택:"
    echo "   /triage [작업 설명]       # 복잡도 분석 → 워크플로우 추천"
    echo ""
    echo "3. 개발 워크플로우:"
    ...
    echo ""
    echo "5. Notion 통합:"
    echo "   /docu [자연어 요청]       # 기능 명세서 관리 (게이트웨이)"
    echo "   /tracker [add|--today]    # 이슈/프로젝트 관리"
    echo ""
    echo "6. 기타:"
    echo "   /dashboard                # 메트릭스 대시보드"
    echo "   /db-sync                  # DB 동기화 (Prod → Dev)"
    echo "   /prisma-migrate           # Prisma 마이그레이션"
    echo ""
    echo "자세한 사용법: ${REPO_URL}#readme"
    echo ""
    echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
}
